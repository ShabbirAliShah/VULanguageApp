...
public class EnrollmentModel implements Serializable {
    ...
    @Ignore
    private Map<String, Lesson> selectedLessons = new HashMap<>(); // Firebase-specific, ignored in Room
    ...
    public EnrollmentModel(String courseId, String courseTitle, String enrollmentId) {
        ...
        this.selectedLessons = new HashMap<>();
    }
    ...
    public Map<String, Object> toMap() {
        ...
        result.put("selectedLessons", selectedLessons);
        return result;
    }
